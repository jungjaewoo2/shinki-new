                     ...
                     <div>
                         <div class="d-flex gap-4">
                             <div class="form-check d-flex align-items-center gap-2">
                                 <input class="form-check-input" type="radio" name="status" id="radioDefault1" value="미확인" ${inquiry.status == '미확인' ? 'checked' : ''}>
                                 <label class="form-check-label" for="radioDefault1">
                                     미확인
                                 </label>
                             </div>
                             <div class="form-check d-flex align-items-center gap-2">
                                 <input class="form-check-input" type="radio" name="status" id="radioDefault2" value="답변진행중" ${inquiry.status == '답변진행중' ? 'checked' : ''}>
                                 <label class="form-check-label" for="radioDefault2">
                                     답변진행중
                                 </label>
                             </div>
                             <div class="form-check d-flex align-items-center gap-2">
                                 <input class="form-check-input" type="radio" name="status" id="radioDefault3" value="답변완료" ${inquiry.status == '답변완료' ? 'checked' : ''}>
                     ...
                     <div>
                         <select name="adminId" class="form-select" aria-label="Default select example">
                             <c:forEach var="admin" items="${admins}">
                                 <option value="${admin.adminNo}" ${admin.adminNo == 1 ? 'selected' : ''}>${admin.name}</option>
                             </c:forEach>
                         </select>
                     </div>
                 </div>
                                 ...
                                 <c:choose>
                                     <c:when test="${not empty reply.adminContent}">
                                         ...
                                         <div class="bg-success bg-opacity-10 p-3 rounded">
                                             <c:out value="${reply.adminContent}"/>
                                         </div>
                                     </c:when>
                                     <c:otherwise>
                                         <!-- 관리자 답변 폼 -->
