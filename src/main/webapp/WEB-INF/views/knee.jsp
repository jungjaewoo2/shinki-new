 ...
 <section id="application" class="application-details page-section">
     ...
     <div class="container">
         ...
         <h2 class="align-items-baseline d-flex flex-column gap-2 mb-4" style="font-size: 3rem; margin-top: 0.75rem;">
             <span class="pill fw-bold">KNEE</span>
             <div class="d-flex flex-column flex-lg-row gap-4 w-100">
                 <div class="fw-bold">KNEE</div>
                     ...
                     <div class="accordion-item">
                         ...
                         <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                             <div class="accordion-body">
                                 <ul>
                                     <li>- MR image를 사용하여 Bone, Meniscus 및 Cartilage를 자동으로 추출할 수 있습니다.</li>
                                     <li>- Caltilage와 Meniscus의 두께 등을 분석할 수 있습니다.</li>
                                 </ul>
                 ...
                 <div class="swiper mySwiper3">
                     <div class="swiper-wrapper">
                         <div class="swiper-slide slide01">
                             ...
                             <img src="/assets/images/knee-analysis-img01.jpg" width="" data-bs-toggle="modal" data-bs-target="#imageModal">
                             <div class="slide-title fs-4 pt-1">Femur Cartilage</div>
                         </div>
                         <div class="swiper-slide slide02">
                             
                             <img src="/assets/images/knee-analysis-img02.jpg" width="" data-bs-toggle="modal" data-bs-target="#imageModal">
                             <div class="slide-title fs-4 pt-1">Knee 3D</div>
                         </div>
                         <div class="swiper-slide slide03">
                             
                             <img src="/assets/images/knee-analysis-img03.jpg" width="" data-bs-toggle="modal" data-bs-target="#imageModal">
                             <div class="slide-title fs-4 pt-1">Knee Rendering</div>
                         </div>
                         <div class="swiper-slide slide04">
                             
                             <img src="/assets/images/knee-analysis-img04.jpg" width="" data-bs-toggle="modal" data-bs-target="#imageModal">
                             <div class="slide-title fs-4 pt-1">Meniscus distance</div>
                         </div>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="function-box d-flex flex-column flex-lg-row gap-3">
                     <div><img src="/assets/images/function-icon11.png" height=""></div>
                     <div>
                         <div class="fw-bold fs-3">Cartilage</div>
                         <ul>
                             <li>- Cartilage의 두께를 color mapping을 통해 확인하고 loss area의 면적을 측정할 수 있습니다.</li>
                             <li>- Cartilage의 Thickness, Volume, Area ratio 측정을 통한 정령화 분석이 가능합니다</li>
                         </ul>
                     </div>
                 </div>
                 <div class="function-box d-flex flex-column flex-lg-row gap-3">
                     <div><img src="/assets/images/function-icon12.png" height=""></div>
                     <div>
                         <div class="fw-bold fs-3">Meniscus</div>
                         <ul>
                             <li>- Meniscus와 Tibia bone 사이의 거리를 측정하여 extrusion을 관찰할 수 있습니다.</li>
                             <li>- Signal intensy를 시각화하여 관찰할 수 있습니다.</li>
                             <li>- Meniscus의 Volume, Width, Thickness 등을 관찰할 수 있습니다.</li>
                         </ul>
                     </div>
                 </div>
             </div>
