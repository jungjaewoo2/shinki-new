...
<div id="login-page" class="page d-flex flex-column h-100">
    ...
    <div class="card flex-fill h-100">
        <div class="page-title text-center m-5">비밀번호 찾기</div>
        ...
        <div class="row">
            <div class="col-12 col-lg-3 m-auto">
                <form action="/mypage/find-psw" method="post">
                    ...
                    <div class="button-group">
                        <button type="submit" class="btn btn-light-green" style="flex: 1;">비밀번호 찾기</button>
                    </div>
                </form>
