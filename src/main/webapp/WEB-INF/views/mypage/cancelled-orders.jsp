...
<jsp:include page="header.jsp" />
 ...
 <div id="orders-page" class="page d-flex flex-column h-100">
     <div class="align-items-center d-flex flex-column flex-lg-row justify-content-between page-header">
        <div class="page-title">취소 내역</div>
        <div class="breadcrumb">마이페이지 > 의뢰 내역 > 취소 내역</div>
    </div>
                     ...
                     <div class="card">
                        <div class="card-header">
                         ...
                         <div class="d-flex justify-content-between align-items-center gap-3">
                             <div class="order-type d-flex flex-column justify-content-end text-center bg-body-secondary rounded p-2 h-100" style="color: #666;">
                                 <div class="">
                                     <c:choose>
